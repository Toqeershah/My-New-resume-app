export const personalData = {
	name: "Toqeer Abid",
	description: "Metaverse and WordPress Developer",
	education: [
		"Bachelor of Science in Computer Science, University of Bahawalpur(2017-2021)",
		"The Web 3.O and Metaverse Developer, UMT Lahore (2022-2023)",
	],
	contactLinks: [
		"https://twitter.com/ToqeerS17253999",
		"mailto:emailto:time2code@gmail.com",
		"https://www.linkedin.com/in/toqeer-shah-98935123a/",
	],
};
...
export const skills = {
	soft: [
		...
		{ icon: "💬", text: "Attractive Communication" },
		{ icon: "👥", text: "Collaboration" },
		{ icon: "⽓", text: "Parallel work" },
